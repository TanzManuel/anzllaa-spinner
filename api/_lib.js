...
export const prizes=[{name:'Rp10.000',weight:25},{name:'Rp20.000',weight:18},{name:'Rp50.000',weight:10},{name:'Voucher',weight:15},{name:'Pulsa 10K',weight:15},{name:'Coba Lagi',weight:10},{name:'Rp100.000',weight:5},{name:'Hadiah Spesial',weight:2}];
...
export function pickPrize(){let r=Math.random()*prizes.reduce((a,p)=>a+p.weight,0);for(let i=0;i<prizes.length;i++){r-=prizes[i].weight;if(r<0)return i}return prizes.length-1}
